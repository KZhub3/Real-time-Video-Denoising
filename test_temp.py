...
from models_megvii3 import FastDVDnet
...
NUM_IN_FR_EXT = 3 # temporal size of patch
MC_ALGO = 'DeepFlow' # motion estimation algorithm
OUTIMGEXT = '.png' # output images format
mylog1 = open('logs/'+'mylog1'+'.log','w')
...
def test_fastdvdnet(**args):
	...
	model_temp.eval()
	print("here is ",model_temp.parameters, file=mylog1)
	...
	logger.info("\tPSNR noisy {:.4f}dB, PSNR result {:.4f}dB".format(psnr_noisy, psnr));print(psnr);print(runtime)
